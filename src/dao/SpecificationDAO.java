...
public class SpecificationDAO extends BaseHibernateDAO {
	...
	public static final String SPEC_XML = "specXml";
	...
	public List findByExample(Specification instance) {
		...
		try {
			List results = getSession().createCriteria("dao.Specification")
	...
	public List findBySpecXml(Object specXml) {
		return findByProperty(SPEC_XML, specXml);
	}
